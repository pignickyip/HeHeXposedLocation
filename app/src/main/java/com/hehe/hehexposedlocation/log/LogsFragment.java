...
import static com.hehe.hehexposedlocation.log.XposedApp.WRITE_EXTERNAL_PERMISSION;

public class LogsFragment extends FragmentActivity {
...
*/
    ...
    private File save() {
        if (ActivityCompat.checkSelfPermission((Activity)this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            //FragmentCompat.requestPermissions((Fragment)this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_EXTERNAL_PERMISSION);
            return null;
    }
    ...
    private class LogsReader extends AsyncTask<File, Integer, String> {
        ...
        protected void onPreExecute() {
            //mProgressDialog = new MaterialDialog.Builder((Activity)this).content(R.string.loading).progress(true, 0).show();
        }
