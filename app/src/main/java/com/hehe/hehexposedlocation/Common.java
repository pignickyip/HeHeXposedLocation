...
public class Common {
    ...
    public static final String WHITELIST_HEHEXPOSED_KEY = "WHITELIST_HEHEXPOSED_KEY";
    public static final String WHITELIST_DISPLAY_HEHEXPOSED_KEY = "WHITELIST_DISPLAY_HEHEXPOSED_KEY";
    public static final String WHITELIST_APPSLIST = "WHITELIST_APPSLIST";
    public static final String WHITELIST_FILTER_CHOICE = "WHITELIST_FILTER_CHOICE";
    public static final String WHITELIST_ENABLE_KEY = "WHITELIST_ENABLE_KEY";
    public static final String WHITELIST_APPS_LIST_KEY = "WHITELIST_APPS_LIST_KEY";
    ...
    public static final String BGDFGDRECORD_ENABLEKEY = "BGDFGDRECORD_ENABLEKEY";
    public static final String BGDFGDRECORDKEY_ENABLE = "BGDFGDRECORDKEY_ENABLE";
    public static final String BGDFGDRECORDKEY_SERVICE_ENABLE = "BGDFGDRECORDKEY_SERVICE_ENABLE";
    public static final String BGDFGDRECORDKEYUP = "BGDFGDRECORDKEYUP";
    public static final String BGDFGDRUNNINGAPPLICATION = "BGDFGDAPPLICATION";
